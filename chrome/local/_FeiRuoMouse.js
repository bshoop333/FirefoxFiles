...
var GesCustomCommand = [
	//示例：
	{
		...
		label: "繁化简",
		command: function(event) {
			content.document.documentElement.appendChild(content.document.createElement("script")).src = "https://github.com/YandLiu/Userscript/raw/master/%E7%B9%81%E5%8C%96%E7%AE%80.user.js";
		}
	}, {
		label: "简化繁",
		command: function(event) {
...
var DragCustomCommand = [
	...
	/*图片*/
	{
		...
		Type: "Image",
		command: function(event) {
			var path = "C:\\Users\\Yandong\\Desktop";
