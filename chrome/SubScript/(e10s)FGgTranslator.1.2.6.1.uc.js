...
// @Note           [150802]修复google发音。
// @Note           [151219]修复google翻译。
// @Note           [160513]修复bing和google翻译。
// @Note           [160513]修复baidu发音语速；使用AudioContext代替Chrome环境下的Audio 跳过网站CSP。
// @Note           [161104]延迟模拟手势结束事件。
// ==/FireGesturesScript==
	var FGgTranslator = {
			offset: {
